...
class AdsComponent extends Component {
  ...
  render() {
    ...
    return (
      <div id="right-panel" className="ads right-panel">
          ...
          <div className="col-9 content-block">
            ...
            <div className="identity-block">
              ...
              <RDropdown
                ...
                dataArr={this.state.instaAccArr}
                  ...
                  <Row>
                    <Col className="blocks">
                      <Row>
                        ...
                        />
                        <img
                          src="/assets/icons/remove/remove@3x.png"
                          alt=""
                          className="col-2 remove"
                        />
                        <Col lg={12}>
                          <RButton
                            text="Select Image"
...
const mapDispatchToProps = dispatch => {
  const actions = { createAdCreatives };
