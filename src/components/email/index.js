    ...
    return (
      <div className="container-fluid">
        <Row className="reset-password text-center">
          <Col className="left">
            <img className='header-logo' src="/assets/bitmap-imgs/logo1.png"></img>
            ...
            <img src="/assets/3bitmap-imgs/social-dashboard.png"></img>
            ...
            <Row className="logo-images">
                <Col><img style={{float: 'right'}} src='/assets/bitmap-imgs/facebook.png'></img></Col>
                <Col><img style={{float: 'left'}} src='/assets/bitmap-imgs/google.png'></img></Col>
            </Row>
          </Col>
          <Col className="right">
